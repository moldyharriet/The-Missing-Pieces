...
def boss_window():
    ...
    def submitaction():
        cwd = os.getcwd()
        path = (cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\bossinfo.txt")
    ...
    cwd = os.getcwd()
    file_exists = os.path.exists(cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\bossinfo.txt")
    print(file_exists)
    if file_exists == "False":
        new_file = open("bossinfo.txt", "x")
    path = (cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\bossinfo.txt")
...
def npc_window():
    ...
    def submitaction():
        cwd = os.getcwd()
        path = (cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\npcinfo.txt")
        npcfile = open(path, "r+")
    ...
    savewarning.pack(pady = 10)
    cwd = os.getcwd()
    file_exists = os.path.exists(cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\npcinfo.txt")
    print(file_exists)
    if file_exists == "False":
        new_file = open("npcinfo.txt", "x")
    path = (cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\npcinfo.txt")
    with open(path, 'r') as i:
        nwindow_text.insert(INSERT, i.read())
...
def sidequest_window():
    ...
    def submitaction():
        cwd = os.getcwd()
        path = (cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\sidequestinfo.txt")
    ...
    savewarning.pack(pady = 10)
    cwd = os.getcwd()
    file_exists = os.path.exists(cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\sidequestinfo.txt")
    print(file_exists)
    if file_exists == "False":
        new_file = open("sidequest.info", "x")
    path = (cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\sidequestinfo.txt")
    with open(path, 'r') as i:
        nwindow_text.insert(INSERT, i.read())
...
def dungeon_window():
    ...
    def submitaction():
        cwd = os.getcwd()
        path = (cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\dungeoninfo.txt")
    ...
    savewarning.pack(pady = 10)
    cwd = os.getcwd()
    file_exists = os.path.exists(cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\dungeoninfo.txt")
    print(file_exists)
    if file_exists == "False":
        new_file = open("dungeoninfo.txt")
    path = (cwd + r"\Downloads\The-Missing-Pieces-main\The Missing Pieces\dungeoninfo.txt")
    with open(path, 'r') as i:
        nwindow_text.insert(INSERT, i.read())
